...
public class RegisterSecurityHashActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        editName.getEditText().setText("hash");
        ...
        btnEnviar.setOnClickListener(v->{
            ...
            if (isEmailValid && isPasswordValid && isNameValid) {
                ...
                boolean rt = service.inSignHash(model);
                if(!rt){
                ...
                startActivity(new Intent(v.getContext(), LoginSecurityHashActivity.class));
                finish();
            }
        });
    }
    ...
    public void onLogin(View view){
        Intent i = new Intent(view.getContext(), LoginSecurityHashActivity.class);
        startActivity(i);
        //finish();
    }
}
